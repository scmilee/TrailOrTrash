...
RSpec.describe "adding a national park", type: :system do
  
  it "allows a user to create a national park " do
  ...
  it "does not allow a user to create a park without a name" do
    visit new_national_park_path
    fill_in "Name", with: ""
    click_on ("Create National Park")
